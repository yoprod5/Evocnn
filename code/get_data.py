...
# convert class vectors to binary class matrices
    ...
    #t_label = tf.keras.utils.to_categorical(t_label, num_classes)
    #t_label=np.reshape(t_label,[50000])
    ...
    #t_image=t_image.batch(batch_size)
    #t_image = t_image.batch(batch_size, drop_remainder=True)
    print(t_image.shape, "train shape")
    print(t_label.shape, "t_label.shape")
...
# Make sure images have shape (28, 28, 1)
    ...
    #print(t_image.shape, "train shape")
    #print(t_label.shape, "label shape")
...
# convert class vectors to binary class matrices
    ...
    #print("x_label shape:",len(t_label.shape))
     #t_image = np.reshape(t_image, [10000, 28, 28, 1], order='F')
    #t_label=t_label.reshape(10000,)
    #y_train=.reshape([10000])
